...
export default function VariantUpdate({ variant, productId, product }: { variant: any, productId: number, product: any }) {
    ...
    const updateVariant = async (e: any) => {
        e.preventDefault();
        setIsSumit(true);
        const { success, message } = await updateVariantByProduct(productId, variant.id, formData);
        if (!success) {
            toast.error(message);
        } else {
    ...
    return (
        <>
            <form onSubmit={updateVariant} method="POST" role="form" id="formCreateProduct">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="card mb-4">
                            <div className="card-header custom border-bottom">
                                <h4>{product.name} <span className={`badge badge-${product.status}`}>{product.status}</span></h4>
                            </div>
                            <div className="card-body">
                                <div className="mt-3">
