        ...
        <div className="row">
          <div className="col-md-8">
              ...
              <div className="card-body">
                <div className="mt-3 mb-3">
                  ...
                  <input
                    ...
                    placeholder=""
                  />
                  <div className="invalid-feedback">Header js</div>
                </div>
              </div>
            </div>
            <div className="card mb-4">
            ...
            <div className="card mb-4">
              ...
              <div className="card-body">
                <div className="mb-3">
                  <label htmlFor="google_map" className="form-label font-small">
                    Google map
                  </label>
                  <textarea
                    name="google_map"
                ...
                <div className="mb-3">
                  <label
                    htmlFor="google_mastertool"
                    className="form-label font-small"
                  >
                    Google master tool
                  </label>
                  <textarea
                    name="google_mastertool"
                    className="form-control is-invalid"
                    id="google_mastertool"
                    cols={30}
                    rows={7}
                  ></textarea>
                  <div className="invalid-feedback">Header js</div>
                ...
                <div className="mb-3">
                  <label htmlFor="head_js" className="form-label font-small">
                    Head JS
                  </label>
                  <textarea
                    name="head_js"
                ...
                <div className="mb-3">
                  <label htmlFor="body_js" className="form-label font-small">
                    Head JS
                  </label>
                  <textarea
                    name="body_js"
