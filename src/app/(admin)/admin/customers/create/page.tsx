    ...
    return (
        <>
            <div className="d-flex justify-content-between mb-3">
                <h4 className="fw-bold"><span className="text-muted fw-light">Admin / Customer /</span> Create</h4>
                <Link href={`/admin/customers`} className="btn btn-secondary">Go back</Link>
            </div>
            <div className="row">
                            ...
                            <div className="card-body">
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control is-invalid"
                                        name="full_name" defaultValue="" id="full_name" placeholder="David Mach" />
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <input className="form-control is-invalid" type="text"
                                                name="phone" id="phone" placeholder="Phone" defaultValue="" />
                                            <div className="invalid-feedback">
                                                Feedback
                                            </div>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input className="form-control is-invalid " type="text"
                                        name="username" id="username" placeholder="Username" defaultValue="" />
                                    <div className="invalid-feedback">
                                        Feedback
                                    </div>
                                </div>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="confirm_password" className="form-label">New password</label>
                                    <input type="password" className="form-control is-invalid"
                                        name="confirm_password" defaultValue="" id="confirm_password"
                                        placeholder="******" />
                                    <div className="invalid-feedback">
                                        Feedback
                                    </div>
                                ...
                                <div className="mb-3">
                                    ...
                                    <select className="form-select is-invalid" name="customer_status_id"
