    ...
    return (
        <>
            <div className="d-flex justify-content-between mb-3">
                <h4 className="fw-bold"><span className="text-muted fw-light">Admin /</span> Customer</h4>
                <Link href={`/admin/customers/create`} className="btn btn-primary">Add customer</Link>
            </div>
                            ...
                            <table className="table">
                                ...
                                <tbody className="table-border-bottom-0">
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                className="badge badge-published">Published</span>
                                        </td>
                                        <td>
                                            <div className="dropdown">
                                                <a className="btn btn-secondary btn-custom"
                                                    href="">
                                                    <span>
